...
public class LibrosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {            
            ...
            request.setAttribute("venta", codigoVenta);
            request.setAttribute("codigoLibro", codigoLibro);
            request.setAttribute("titularTarjeta",titularTarjeta);
